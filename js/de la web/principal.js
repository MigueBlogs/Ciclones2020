    ...
    require([
      ...
      function (
        ...
        parser.parse();
          ...
          worldPopulationGP = new Geoprocessor("https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Demographics/ESRI_Population_World/GPServer/PopulationSummary");
          worldPopulationGP.setOutputSpatialReference({wkid:102100});
        ...
        function showCoordinates(evt) {
          ...
          if (slatitud<0){
           ...
           dom.byId("ubicacion").innerHTML = "Latitud:" + mp.y.toFixed(5) + "/" + dlati + "°" + mlatitud + "'" + slatitud + "''" + "," +
                                             "Longitud:" + mp.x.toFixed(5) + "/" + dlong + "°" + mlongitud + "'" + slongitud + "''";
        }
...
function createWorldPopulationRandomText() {
  randomWorldTextInterval = setInterval(function(){
    $(".resultNumberWorld").each(function(){
      $(this).text(agregasComas(Math.floor(Math.random() * 99999)));
    })
  }, delay);
}
...
function limpiarGeometria() {
    ...
    $(".resultNumberWorld").each(function(idx, el){
      $(el).text("0");
    });
  
    $("#world").css("display", "none");
    $("#worldPopulation").css("display", "none");
