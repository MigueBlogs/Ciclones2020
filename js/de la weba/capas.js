                ...
                if (!Existe) {
                    switch (layerSeleccion) {
                        ...
                        case "covid":        
                            ...
                            var covidlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/COVID19/Restringido/MapServer", { id: "covid" });
                            //var div2 = " <div class='divCapas' title=''>" + covidlayer.id + "<img id='covid' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                             var div2 = " <div class='divCapas' title=''><span id='covid_title'>" + "COVID-19" + "</span> <img id='covid' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: covidlayer, collapsed: false, slider: true });
                        ...
                        case "sanitarios":
                            ...
                            var sanilayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANR/Sanitario_Ecologicos/MapServer", { id: "sanitarios" });
                        ...
                        case "anricentro":
                            ...
                            var anricentrolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANRI/RegionCentro_ANRI/MapServer", { id: "anricentro" });
                            //var div2 = " <div class='divCapas' title=''>" + anricentrolayer.id + "<img id='anricentro' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Atlas Nacional de Riesgos por Inundaci&oacute;n Centro "+ "<img id='anricentro' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: anricentrolayer, collapsed: false, slider: true });

                        break;

                        case "anrinoreste":

                            var anrinorestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANRI/RegionNoreste_ANRI/MapServer", { id: "anrinoreste" });
                            //var div2 = " <div class='divCapas' title=''>" + anrinorestelayer.id + "<img id='anrinoreste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Atlas Nacional de Riesgos por Inundaci&oacute;n Noreste "+ "<img id='anrinoreste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: anrinorestelayer, collapsed: false, slider: true });

                        break;

                        case "anrinoroeste":

                            var anrinoroestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANRI/RegionNoroeste_ANRI/MapServer", { id: "anrinoroeste" });
                            ...
                            var div2 = " <div class='divCapas' title=''>" + "Atlas Nacional de Riesgos por Inundaci&oacute;n Noroeste "+ "<img id='anrinoroeste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: anrinoroestelayer, collapsed: false, slider: true });

                        break;

                        case "anrioccidente":

                            var anrioccidentelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANRI/RegionOccidente_ANRI/MapServer", { id: "anrioccidente" });
                            ...
                            var div2 = " <div class='divCapas' title=''>" + "Atlas Nacional de Riesgos por Inundaci&oacute;n Occidente "+ "<img id='anrioccidente' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: anrioccidentelayer, collapsed: false, slider: true });

                        break;

                        case "anrisureste":

                            var anrisurestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANRI/RegionSureste_ANRI/MapServer", { id: "anrisureste" });
                            ...
                            var div2 = " <div class='divCapas' title=''>" + "Atlas Nacional de Riesgos por Inundaci&oacute;n sureste "+ "<img id='anrisureste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: anrisurestelayer, collapsed: false, slider: true });
                        ...
                        case "atronomicos":
                            ...
                            var atronomicoslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANR/Astronomicos/MapServer", { id: "atronomicos" });
                            //var div2 = " <div class='divCapas' title=''>" + atronomicoslayer.id + "<img id='atronomicos' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Astronómicos" + "<img id='atronomicos' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: atronomicoslayer, collapsed: false, slider: true });
                        ...
                        case "cambioClima":
                            ...
                            var cambioClimalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANR/Cambio_Climatico/MapServer", { id: "cambioClima" });
                        ...
                        case "escenario":
                            ...
                            var escenariolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/Restringidos/Escenarios_restringida/MapServer", { id: "escenario" });
                            //var div2 = " <div class='divCapas' title=''>" + escenariolayer.id + "<img id='escenario' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Escenarios" + "<img id='escenario' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: escenariolayer, collapsed: false, slider: true });

                        break;

                        case "fundamentales":

                            var fundamentalesLayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/ANR/Datos_Fundamentales/MapServer", { id: "fundamentales" });
                            //var div2 = " <div class='divCapas' title=''>" + fundamentalesLayer.id + "<img id='fundamentales' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Datos Fundamentales" + "<img id='fundamentales' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: fundamentalesLayer, collapsed: false, slider: true });

                        break;

                        case "macrosimulacro":

                            var MacrosimulacroLayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios1.cenapred.unam.mx:6080/arcgis/rest/services/Restringidos/Simulacro/MapServer", { id: "macrosimulacro" });
                            //var div2 = " <div class='divCapas' title=''>" + MacrosimulacroLayer.id + "<img id='macrosimulacro' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            var div2 = " <div class='divCapas' title=''>" + "Macrosimulacro" + "<img id='macrosimulacro' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                            legendLayers.push({ id: id, title: div2,layer: MacrosimulacroLayer, collapsed: false, slider: true });
                        ...
                        case "aguascalientes":
                            ...
                            aguaslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaAguascalientes/MapServer", { id: "aguascalientes" });
                        ...
                        case "bajaCalifornia":
                            ...
                            bajalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaBajaCalifornia/MapServer", { id: "bajaCalifornia" });
                        ...
                        case "bajaCaliforniaSur":
                            ...
                            bajasurlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaBajaCaliforniaSur/MapServer", { id: "bajaCaliforniaSur" });
                        ...
                        case "campeche":
                            ...
                            campechelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaCampeche/MapServer", { id: "campeche" });
                        ...
                        case "coahuila":
                            ...
                            coahuilalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaCoahuila/MapServer", { id: "coahuila" });
                        ...
                        case "colima":
                            ...
                            colimalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaColima/MapServer", { id: "colima" });
                        ...
                        case "chiapas":
                            ...
                            chiapaslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaChiapas/MapServer", { id: "chiapas" });
                        ...
                        case "chihuahua":
                            ...
                            chihuahualayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaChihuahua/MapServer", { id: "chihuahua" });
                        ...
                        case "cdmexico":
                            ...
                            cdmexicolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaDF/MapServer", { id: "cdmexico" });
                        ...
                        case "durango":
                            ...
                            durangolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaDurango/MapServer", { id: "durango" });
                        ...
                        case "guanajuato":
                            ...
                            guanajuatolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaGuanajuato/MapServer", { id: "guanajuato" });
                        ...
                        case "guerrero":
                            ...
                            guerrerolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaGuerrero/MapServer", { id: "guerrero" });
                        ...
                        case "hidalgo":
                            ...
                            hidalgolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaHidalgo/MapServer", { id: "hidalgo" });
                        ...
                        case "jalisco":
                            ...
                            jaliscolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaJalisco/MapServer", { id: "jalisco" });
                        ...
                        case "edoMexico":
                            ...
                            edoMexicolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaEdoMex/MapServer", { id: "edoMexico" });
                        ...
                        case "michoacan":
                            ...
                            michoacanlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaMichoacan/MapServer", { id: "michoacan" });
                        ...
                        case "morelos":
                            ...
                            moreloslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaMorelos/MapServer", { id: "morelos" });
                        ...
                        case "nayarit":
                            ...
                            nayaritlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaNayarit/MapServer", { id: "nayarit" });
                        ...
                        case "nuevoLeon":
                            ...
                            nuevoLeonlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaNuevoLeon/MapServer", { id: "nuevoLeon" });
                        ...
                        case "oaxaca":
                            ...
                            oaxacalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaOaxaca/MapServer", { id: "oaxaca" });
                        ...
                        case "puebla":
                            ...
                            pueblalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaPuebla/MapServer", { id: "puebla" });
                        ...
                        case "queretaro":
                            ...
                            queretarolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaQueretaro/MapServer", { id: "queretaro" });
                        ...
                        case "quintanaRoo":
                            ...
                            quintanaRoolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaQuintanaRoo/MapServer", { id: "quintanaRoo" });
                        ...
                        case "sanLuisPotosi":
                            ...
                            sanluislayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaSanLuisPotosi/MapServer", { id: "sanLuisPotosi" });
                        ...
                        case "sinaloa":
                            ...
                            guanajuatolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaSinaloa/MapServer", { id: "sinaloa" });
                        ...
                        case "sonora":
                            ...
                            sonoralayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaSonora/MapServer", { id: "sonora" });
                        ...
                        case "tabasco":
                            ...
                            tabascolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaTabasco/MapServer", { id: "tabasco" });
                        ...
                        case "tamaulipas":
                            ...
                            tamaulipaslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaTamaulipas/MapServer", { id: "tamaulipas" });
                        ...
                        case "tlaxcala":
                            ...
                            tlaxcalalayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaTlaxcala/MapServer", { id: "tlaxcala" });
                        ...
                        case "veracruz":
                            ...
                            veracruzlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaVeracruz/MapServer", { id: "veracruz" });
                        ...
                        case "yucatan":
                            ...
                            yucatanlayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaYucatan/MapServer", { id: "yucatan" });
                        ...
                        case "zacatecas":
                            ...
                            zacatecaslayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasEstatales/MapaZacatecas/MapServer", { id: "zacatecas" });
                        ...
                        // Inicio - Servicio de Atlas Municipales por regiones

                        case "noroeste":        
                       
                            var noroestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasMunicipales/RegionNoroeste_AtlasMun/MapServer", { id: "noroeste" });
                            //var div2 = " <div class='divCapas' title=''>" + noroestelayer.id + "<img id='noroeste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                        ...
                        case "noreste":        
                            ...
                            var norestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasMunicipales/RegionNoreste_AtlasMun/MapServer", { id: "noreste" });
                        ...
                        case "occidente":        
                            ...
                            var occidentelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasMunicipales/RegionOccidente_AtlasMun/MapServer", { id: "occidente" });
                            //var div2 = " <div class='divCapas' title=''>" + occidentelayer.id + "<img id='occidente' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
                        ...
                        case "centro":        
                            ...
                            var centrolayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasMunicipales/RegionCentro_AtlasMun/MapServer", { id: "centro" });
                        ...
                        case "sureste":        
                            ...
                            var surestelayer = new esri.layers.ArcGISDynamicMapServiceLayer("http://servicios2.cenapred.unam.mx:6080/arcgis/rest/services/AtlasMunicipales/RegionSureste_AtlasMun/MapServer", { id: "sureste" });
                            //var div2 = " <div class='divCapas' title=''>" + surestelayer.id + "<img id='sureste' title='Eliminar servicio' class='imgCapas' onclick='EliminarServicio(id)' src='imagenes/eliminar.png'/></div>";
